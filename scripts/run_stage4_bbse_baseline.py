...
from src.calibration.losses import (
    brier_score,
...
temperature=temperature,
        ...
        scaled_target_brier = brier_score(
        ...
        temperature_results.append(

            {
                ...
                "target_brier": scaled_target_brier,
...
dtype=float,
    ...
    for result in temperature_results:
        ...
        print(
            ...
            f"Brier={result['target_brier']:.4f}"
